...
An employee needs Docker Desktop. They raise a request on the IT desk. The system checks license availability and installs it automatically via mobile device management (MDM).
...
## Notes
Loss or theft of hardware must be reported to the IT Security Team (security@Darshan_AI_Engineer_Ops.com) within 2 hours of discovery. Additional legal and compliance notes:
