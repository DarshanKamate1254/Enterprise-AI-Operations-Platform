...
To access the customer billing database, a developer must request role-based access in the portal. Once approved, the developer is granted read-only access for a limited 30-day window.
...
## Notes
Our security policy aligns with ISO/IEC 27001:2022 and SOC 2 Type II trust principles. Additional legal and compliance notes:
