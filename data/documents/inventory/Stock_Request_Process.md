...
A systems administrator needs 4 fiber-optic patch cords to connect a new switch. They submit a stock request, the manager auto-approves, and the warehouse dispatches the cables to their desk.
...
## Notes
Returned equipment must be marked as 'Used-Tested' or 'Scrap' before restocking. Additional legal and compliance notes:
...
Q: Can I request a replacement laptop screen?
