...
A customer complains about recurring data sync failures. The agent checks API logs, detects a rate-limit block, requests the admin to white-list the client's IP, verifies successful sync, and updates the client.
...
## Notes
Complaints that carry potential legal or security risks must be escalated immediately to the Legal and Security teams. Additional legal and compliance notes:
...
Q: What is a Level-2 escalation?
