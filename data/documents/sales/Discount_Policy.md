...
A client requests a 12% discount on a 1-year SaaS contract. The Sales Rep enters the discount in the CRM, which routes to their Manager. The Manager reviews the client's growth potential and approves it.
...
## Notes
Discounts cannot be applied retroactively to invoices that have already been generated or paid. Additional legal and compliance notes:
...
Q: Do renewals qualify for discounts?
