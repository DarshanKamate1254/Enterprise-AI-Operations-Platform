...
class TestOperationalGuardrails(unittest.TestCase):
    ...
    def test_pii_detection_redaction(self):
        ...
        raw_text = (
            "Here is the manager contact: ananya.sharma@Darshan_AI_Engineer_Ops-solutions.com. "
        ...
        self.assertNotIn("ananya.sharma@Darshan_AI_Engineer_Ops-solutions.com", redacted)
