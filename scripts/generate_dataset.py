...
docs_metadata = {
    "hr": {
        "Employee_Handbook.md": {
            ...
            "purpose": "To serve as a comprehensive reference guide outlining the core values, employment conditions, workplace guidelines, and standard operating expectations at AI_OOPS Pvt. Ltd.",
            "scope": "This handbook applies to all regular full-time, part-time, temporary, and contract employees of AI_OOPS Pvt. Ltd., across all locations, subsidiaries, and corporate offices globally.",
            ...
            "faq": "Q: Can I work fully remote?\nA: Remote work eligibility is determined by the department head and HR. AI_OOPS operates on a hybrid model (3 days in-office, 2 days remote).\n\nQ: How do I request a duplicate ID card?\nA: Submit an IT service ticket under the 'Facilities' category.",
        ...
        "Leave_Policy.md": {
            "title": "Leave Policy",
            "purpose": "To define the types of leaves available to AI_OOPS employees, eligibility criteria, accrual methods, and the application and approval processes.",
            "scope": "Applies to all regular full-time and part-time employees on the AI_OOPS payroll globally.",
            ...
            "policy": "AI_OOPS offers generous paid time off to promote work-life balance, recovery, and personal well-being. Annual leave allocations include Casual Leave (CL), Sick Leave (SL), Earned Leave (EL), Maternity Leave, Paternity Leave, and Bereavement Leave. Unused Earned Leaves up to 30 days can be carried forward to the next calendar year.",
        ...
        "Attendance_Policy.md": {
            ...
            "scope": "Applies to all employees working from corporate offices or remote locations on behalf of AI_OOPS.",
        ...
        "Travel_Policy.md": {
            ...
            "scope": "Applies to all domestic and international business travel undertaken by AI_OOPS employees.",
            ...
            "faq": "Q: Can I book my own flights?\nA: No, all bookings must be processed by the AI_OOPS travel desk to avail of corporate discount rates.\n\nQ: What happens if I lose a receipt?\nA: For expenses under INR 500, a written declaration is accepted. Above that, missing receipts require department head approval.",
            "revision_history": "| Version | Date | Author | Description of Changes |\n| --- | --- | --- | --- |\n| 1.0 | 2026-01-15 | Vikram Sen (VP Finance) | FY26 Unified Corporate Travel Policy |"
        },
        "Code_of_Conduct.md": {
            "title": "Code of Conduct",
            "purpose": "To define the ethical standards, behavioral expectations, and corporate responsibilities required of all employees and stakeholders at AI_OOPS.",
            "scope": "Applies to all employees, board members, vendors, partners, and contractors representing AI_OOPS globally.",
    ...
    "finance": {
        "Finance_Policy.md": {
            ...
            "purpose": "To establish the core financial controls, authorization matrices, budget allocations, and auditing protocols of AI_OOPS.",
            "scope": "Applies to all financial transactions, procurements, vendor payments, and cost-center allocations within AI_OOPS.",
        ...
        "Expense_Reimbursement.md": {
            ...
            "scope": "Applies to all employees of AI_OOPS claiming reimbursements for business travel, client entertainment, internet allowance, and minor office supplies.",
            ...
            "policy": "AI_OOPS reimburses legitimate business expenses. Claims must be submitted within 30 days of the expense date. Entertainment expenses must specify client names and business purposes. Personal expenses, traffic fines, and alcohol purchases are strictly non-reimbursable.",
        ...
        "Budget_Guidelines.md": {
            ...
            "scope": "Applies to all department heads, project managers, and budget owners across AI_OOPS.",
            ...
            "policy": "AI_OOPS operates on an annual budgeting cycle with quarterly reviews. Departments must stick to their allocated budgets. Over-budget spends are not permitted without an approved variance request. Underspent budgets cannot be rolled over to the next year without CFO approval.",
    ...
    "sales": {
        "Sales_Guidelines.md": {
            ...
            "purpose": "To define the ethical guidelines, pipeline stages, lead allocation, and performance metrics for the AI_OOPS Sales team.",
            "scope": "Applies to all Sales Representatives, Account Executives, and Sales Managers at AI_OOPS.",
            "responsibilities": "Sales team members must represent AI_OOPS with integrity. Sales managers are responsible for pipeline reviews. The VP of Sales oversees revenue targets and commissions.",
        ...
        "Pricing_Policy.md": {
            ...
            "purpose": "To establish the official product pricing sheets, subscription models, and pricing authority levels at AI_OOPS.",
            "scope": "Applies to all products, SaaS services, and support contracts offered by AI_OOPS.",
            ...
            "policy": "AI_OOPS offers transparent subscription-based and usage-based pricing. Standard pricing is updated annually on January 1. Quoted rates are valid for 30 days from the proposal date. All custom bundles or enterprise packages require pricing committee sign-off.",
        ...
        "Discount_Policy.md": {
            ...
            "purpose": "To define the limits, approval matrices, and criteria for applying discounts to AI_OOPS products and services.",
            ...
            "policy": "AI_OOPS discourages excessive discounting to preserve product value and margin. Discounts are categorized as Standard, Manager-approved, or VP-approved. No discount above 30% is allowed without written CFO and VP Sales approval. Multi-year commitments (2+ years) qualify for automatic tier discounts.",
    ...
    "it": {
        "IT_SOP.md": {
            ...
            "scope": "Applies to all IT hardware, software licenses, network infrastructure, and connected devices owned or managed by AI_OOPS.",
            ...
            "notes": "Loss or theft of hardware must be reported to the IT Security Team (security@AI_OOPS.com) within 2 hours of discovery.",
            "faq": "Q: Can I use my personal laptop for work?\nA: No, only corporate laptops configured with AI_OOPS MDM and security software are permitted to access corporate resources.\n\nQ: How often is hardware replaced?\nA: Laptops are replaced on a 3-year refresh cycle.",
            "revision_history": "| Version | Date | Author | Description of Changes |\n| --- | --- | --- | --- |\n| 1.0 | 2026-01-15 | Amit Patel (IT Operations Lead) | Initial FY26 IT Infrastructure SOP |"
        },
        "API_Documentation.md": {
            "title": "API Documentation Guidelines",
            "purpose": "To standardize the design, authentication, formatting, and deployment documentation of APIs built and consumed by AI_OOPS.",
            "scope": "Applies to all internal and external-facing web APIs developed by AI_OOPS engineering.",
        ...
        "Password_Policy.md": {
            ...
            "purpose": "To define security standard criteria for user passwords and authentication mechanics to protect AI_OOPS networks and applications.",
            "scope": "Applies to all user accounts, active directory credentials, database logins, and third-party SaaS accounts at AI_OOPS.",
            ...
            "faq": "Q: Can I use a password manager?\nA: Yes, AI_OOPS licenses and recommends 1Password Enterprise for all employees to store credentials securely.\n\nQ: Does biometric login bypass MFA?\nA: Biometrics function as the first factor; a secondary authenticator app prompt (MFA) is still required for external logins.",
            "revision_history": "| Version | Date | Author | Description of Changes |\n| --- | --- | --- | --- |\n| 1.0 | 2026-01-15 | Amit Patel (IT Operations Lead) | FY26 Enterprise Password Standards |"
        },
        "Security_Policy.md": {
            "title": "Information Security Policy",
            "purpose": "To establish the cybersecurity posture, data protection rules, access controls, and network security guidelines of AI_OOPS.",
            "scope": "Applies to all data assets, networks, systems, cloud instances, and physical premises of AI_OOPS.",
            ...
            "policy": "AI_OOPS follows the principle of least privilege (PoLP) and Zero Trust architecture. Data must be classified into Public, Internal, Confidential, and Restricted. Sensitive data must be encrypted at rest and in transit. Security assessments are mandatory before code deployments.",
        ...
        "Incident_Response.md": {
            ...
            "scope": "Applies to all security incidents, system outages, data leaks, and cyberattacks at AI_OOPS.",
        ...
        "VPN_Setup_Guide.md": {
            ...
            "scope": "Applies to all employees and contractors requiring remote access to the internal AI_OOPS network.",
            ...
            "policy": "Access to AI_OOPS internal networks is restricted to approved corporate VPN clients. The VPN session must run MFA for verification. VPN credentials must not be shared. Split tunneling is disabled; all remote traffic routes through the secure corporate web gateway.",
    ...
    "customer_support": {
        "Customer_Support_FAQ.md": {
            ...
            "scope": "Applies to all Customer Support representatives and customer-facing staff at AI_OOPS.",
        ...
        "Complaint_Handling.md": {
            ...
            "scope": "Applies to all support representatives, account managers, and customer success managers at AI_OOPS.",
        ...
        "Refund_Policy.md": {
            ...
            "scope": "Applies to all software-as-a-service (SaaS) and support purchases made by AI_OOPS customers.",
    ...
    "inventory": {
        "Inventory_Management.md": {
            ...
            "purpose": "To define guidelines for managing IT physical assets, server hardware, spare parts, and office materials across AI_OOPS warehouses.",
            "scope": "Applies to all storage warehouses, server storage facilities, and asset tracking portals of AI_OOPS.",
        ...
        "Warehouse_SOP.md": {
            ...
            "purpose": "To document safety regulations, material handling procedures, and security checks for the main AI_OOPS logistics center.",
...
def generate_policy_document(category, filename, doc_meta):
    ...
    expanded_purpose = (
        f"{purpose_text} This document serves as a foundational pillar of governance within AI_OOPS Pvt. Ltd., "
    ...
    expanded_scope = (
        ...
        "of this document during their engagement with AI_OOPS."
    )
    ...
    expanded_policy = (
        f"{policy_text} AI_OOPS Pvt. Ltd. believes in fostering an environment of trust, safety, and mutual respect. "
    ...
    expanded_proc = (
        ...
        f"{proc_text}\n\n"
        "5. Auditing and Logging: All activities related to this workflow are logged in the AI_OOPS central compliance database. "
    ...
    expanded_ex = (
        ...
        "of AI_OOPS's procurement pipeline."
    )
    ...
    doc_content = f"""# {title} - AI_OOPS Pvt. Ltd.
...
employees.append({
    ...
    "email": "devendra.rao@aioops-solutions.com",
...
vps = {
    2: {"name": "Neha Gupta", "title": "VP of Engineering", "salary": 2900000.00, "email": "neha.gupta@aioops-solutions.com", "phone": "+91-98765-43211"},
    3: {"name": "Ananya Sharma", "title": "HR Director", "salary": 2100000.00, "email": "ananya.sharma@aioops-solutions.com", "phone": "+91-98765-43212"},
    4: {"name": "Vikram Sen", "title": "VP of Finance", "salary": 2600000.00, "email": "vikram.sen@aioops-solutions.com", "phone": "+91-98765-43213"},
    5: {"name": "Sarah Jenkins", "title": "VP of Sales", "salary": 2800000.00, "email": "sarah.jenkins@aioops-solutions.com", "phone": "+91-98765-43214"},
    6: {"name": "Meera Nair", "title": "Head of Customer Support", "salary": 2000000.00, "email": "meera.nair@aioops-solutions.com", "phone": "+91-98765-43215"}
}
...
for i in range(7, 51):
    ...
    name = f"{first} {last}"
    email = f"{first.lower()}.{last.lower()}{i}@aioops-solutions.com"
...
for i in range(1, 41):
    ...
    supplier = f"AI_OOPS Internal Systems" if "SaaS" in category or "Services" in category else f"Hardware Vendor {i%3+1}"
...
seed_sql.append("-- AI_OOPS Pvt. Ltd.\n")
