...
This guide describes how to manually test the **NovaTech AI Enterprise Operations Platform Control Panel** dashboard, validating core features such as multi-agent chat workflows, role-based access control (RBAC) document ingestion, database schema inspection, and real-time observability metrics.
